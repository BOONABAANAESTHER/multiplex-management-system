...
$query="update  userRegistration set fname=?,mname=?,lname=?,gender=?,contactNo=?,updationDate=? where id=?";
...
<div class="col-sm-8">
<input type="password" name="password" id="email"  class="form-control" value="<?php echo $row->email;?>" readonly>
<span id="user-availability-status" style="font-size:12px;"></span>
</div>
</div>
<?php } ?>
